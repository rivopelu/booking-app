    ...
    return (
        <div className="headerSearch">
            ...
            <div className="headerSearchItem" >
                ...
                <span style={{ cursor: 'pointer' }} onClick={() => setOpenDate(!openDate)} className='headerSearchText'>{`${format(date[0].startDate, "MM/dd/yyy")} to ${format(date[0].startDate, "MM/dd/yyy")}`}</span>
                {openDate && <DateRange
